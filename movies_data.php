...
$Movie_Links_480p =  "https://hdfile.live/download_now.php?id=".$row['480p_links']; 
$Movie_Links_720p = "https://hdfile.live/download_now.php?id=".$row['720p_links'];
$Movie_Links_1080p = "https://hdfile.live/download_now.php?id=".$row['1080p_links'];
...
<html lang="en">
<head>
	<title><?php echo $Movie_ShortName; ?> Download -hdfile.live</title>
	<meta charset="utf-8">
		...
		<div class="container">
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
				<div class="border_box">
					...
					<div class="">
						<div class="mimage"><img src='<?php echo (!empty($Movie_Image)) ? ((strpos($Movie_Image, "http") === 0) ? $Movie_Image : "admin/photo/$Movie_Image") : "img/default-poster.jpg"; ?>'>
</div>
                        ...
                        <div class="ssimage" style="text-align: center;">
  <?php
    // Screenshot image names from the database
    $screenshots = array(
      isset($row['ss_images1']) ? $row['ss_images1'] : '',
      isset($row['ss_images2']) ? $row['ss_images2'] : '',
      isset($row['ss_images3']) ? $row['ss_images3'] : '',
      isset($row['ss_images4']) ? $row['ss_images4'] : '',
      isset($row['ss_images5']) ? $row['ss_images5'] : '',
      isset($row['ss_images6']) ? $row['ss_images6'] : '',
    );

    // Loop through each screenshot and display it
    foreach ($screenshots as $ss_img) {
      if (!empty($ss_img)) {
        // If the path is a full URL (from TMDb), use it directly. Otherwise use the local admin folder.
        $src = (strpos($ss_img, 'http') === 0) ? $ss_img : "admin/photo/" . $ss_img;
        echo "<img src='$src' alt='Screenshot' style='width:85%; max-width:600px; margin:10px; border:1px solid #ddd;'>";
      }
    }
  ?>
</div>
